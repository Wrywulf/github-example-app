...
package com.jayway.example.github.navigation;
 ...
 *
 * UBH: A copy of {@link androidx.navigation.ui.NavigationUI} but migrated to use androidx AppCompat
 */
public class NavigationUIX {

    // No instances. Static utilities only.
    private NavigationUIX() {
    }
